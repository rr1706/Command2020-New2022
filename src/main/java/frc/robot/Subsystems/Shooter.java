...
import frc.robot.Utilities.LinearInterpolationTable;
  ...
  private final RelativeEncoder m_shooterEncoder1 = m_shooterMotor1.getEncoder();
  //Create double solenoid for the shooter "flap"
  private static DoubleSolenoid flap = new DoubleSolenoid(PneumaticsModuleType.CTREPCM,ShooterConstants.kFlapSolenoids[0], 
